...
const zhCN: Locale = {
  ...
  header: {
    ...
    syncUpToDate: "已是最新",
    syncDone: "同步完成",
    pullDirtyTitle: "未提交的更改",
    pullDirtyMessage: "你的未提交更改将在拉取前被暂存，之后会自动恢复。",
    pullDirtyConfirm: "储藏并拉取",
    pullRefusedDirty: "拉取被拒绝：存在未提交的更改。",
    pullAutostashParked: "已拉取——你的更改已暂存，操作完成后会自动恢复。",
    pullAutostashConflict: "拉取已完成，但恢复你的更改时发生冲突——请在更改视图中解决。你的更改已安全保存在储藏中。",
    pushDone: "推送已完成",
  ...
  branchMenu: {
    ...
    forceDeleteConfirm: "\u5206\u652f \u00ab {0} \u00bb \u5c1a\u672a\u5b8c\u5168\u5408\u5e76\u3002\u4ecd\u8981\u5f3a\u5236\u5220\u9664\u5417\uff1f\u672a\u5408\u5e76\u4e14\u4e0d\u5728\u5176\u4ed6\u5206\u652f\u4e0a\u3001\u4e5f\u672a\u63a8\u9001\u5230\u8fdc\u7a0b\u7684\u63d0\u4ea4\u5c06\u4f1a\u4e22\u5931\u3002",
  ...
  log: {
    ...
    graphSearchPlaceholder: "按提交 ID、#pr、作者、分支名、摘要或描述搜索…",
  ...
  branches: {
    ...
    updateDirtyHint: "你的未提交更改将被储藏，并在更新后恢复。",
    updateFailed: "无法更新分支。({0})",
    updatePopConflict: "分支已更新，但恢复你的更改时遇到冲突 — 请在更改视图中解决。你的储藏已保留。",
    reset: "重置",
  ...
  pr: {
    ...
    detail: {
      ...
      reviewers: "评审者",
      reviewApproved: "已批准",
      reviewChangesRequested: "请求修改",
      reviewDismissed: "评审已驳回",
      reviewCommented: "已评论",
      description: "描述",
      noDescription: "无描述。",
  ...
  settings: {
    ...
    logsLevelInfo: "信息",
    aiEnable: "启用 AI 功能",
    aiEnableHint: "启用所有由 AI 驱动的功能：冲突解决建议、提交信息、PR 预审查，以及对暂存更改的提交审查。在下方配置好提供方之前，不会运行任何功能。",
    ...
    ai: {
      ...
      releaseNotes: {
        title: "发布说明模板",
        hint: "模板允许您在生成发布说明的基础提示词上添加自定义指令/规则。",
        sharedNote: "模板在项目之间共享，但分配的模板是为每个项目记忆的。",
        defaultTemplate: "默认",
        empty: "暂无自定义模板。",
        add: "添加模板",
        formName: "模板名称",
    ...
    reviewAi: {
      ...
      preReview: "预审查发现项",
      preReviewHint: "打开 PR 时在后台分析每个文件（可选启用，本地优先）。",
      threshold: "置信度阈值",
      thresholdHint: "低于此置信度的发现项将被隐藏。",
      cap: "每个 PR 的最大发现项数",
      capHint: "按置信度排序显示前 N 项发现。",
      summary: "PR 摘要",
    ...
    pullMerge: "合并",
    pullRebase: "变基（默认）",
    pullDirtyBehavior: "拉取时存在未提交的更改",
    pullDirtyAutostash: "自动储藏并恢复",
    pullDirtyAsk: "询问",
    pullDirtyRefuse: "工作树脏时拒绝",
    pullDirtyHint: "拉取前暂存你的更改，完成后立即恢复。",
    switchBehavior: "切换分支行为",
    switchStash: "自动储藏",
    switchAsk: "询问",
    switchRefuse: "工作树脏时拒绝",
    resetBranchUpdatePrompts: "“更新分支”提醒",
    resetBranchUpdatePromptsBtn: "重新启用",
    resetBranchUpdatePromptsHint: "为所有已静音的分支重新显示检出后的更新提示。",
    fontSize: "字号",
    tabSize: "制表符宽度",
    spaces: "空格",
    terminalFontSize: "终端字号",
    terminalShell: "终端 Shell",
    terminalShellHint: "如 /bin/zsh、pwsh — 留空则使用系统默认 Shell",
    terminalContextMenu: "右键上下文菜单",
    terminalContextMenuHint: "右键时显示包含复制、粘贴、清空和搜索的菜单",
    terminalCopyOnSelect: "选中即复制",
    ...
    launchpad: {
      showTeamTab: {
        label: "\u663e\u793a Today \u56e2\u961f\u6807\u7b7e",
        help: "\u663e\u793a\u5728 Today \u754c\u9762\u7684\u5de6\u4e0a\u89d2\u3002\u56e2\u961f\u6807\u7b7e\u6bcf\u4e2a\u540c\u4e8b PR \u90fd\u4f1a\u8c03\u7528\u4e00\u6b21 API\uff08\u5728\u5927\u578b\u5de5\u4f5c\u533a\u4e0a\u7ea6 10 \u79d2\uff09\u3002\u5982\u679c\u4f60\u4e0d\u9700\u8981\u6587\u4ef6\u91cd\u53e0\u89c6\u56fe\uff0c\u53ef\u4ee5\u5173\u95ed\u3002",
      },
    },
  ...
  launchpad: {
    ...
    inboxFilterEmpty: "没有与此筛选器匹配的事项。",
    inboxSummary: "{0} 个事项 · {1} 个待处理",
    timeMin: "{0} 分钟",
    timeHour: "{0} 小时",
    timeDay: "{0} 天",
    timeWeek: "{0} 周",
  ...
  timeMachine: {
    ...
    restoreTitle: "恢复到此处？",
    restoreConfirm:
      "工作区、暂存区和当前分支将回到此状态。系统会先为当前状态创建快照，因此此操作本身也可撤销。",
    restoreButton: "恢复",
    filterAll: "全部",
    filterSnapshots: "快照",
    filterGit: "Git",
    retentionSummary: "{0} 个节点 · {1} 天",
    sourceSnapshot: "快照",
    sourceReflog: "Git",
    detailWorktree: "工作区 + 暂存区",
    detailConflicts: "保留冲突",
    detailRefMove: "引用移动",
    kindManual: "手动快照",
    kindDiscard: "丢弃更改",
    kindReset: "重置",
    ...
    settingsEnabledHint:
      "在重置、切换、丢弃或批量应用解决方案前，捕获工作区、暂存区和冲突状态。",
    settingsRetentionDays: "快照保留天数",
    settingsMaxCount: "每个仓库的最大快照数",
    settingsAiLabels: "AI 生成的快照标题",
  },
  undoStack: {
    title: "操作历史",
    undoTitle: "回退操作？",
  ...
  submodule: {
    ...
    updateAvailable: "有新更新",
    updateAvailableTooltip: "跟踪分支上有 {0} 个新提交 — 运行“更新”以拉取",
    update: "更新",
    updateOneTooltip: "拉取此子模块跟踪分支上的最新提交",
  ...
  help: {
    ...
    keyboardShortcuts: {
      ...
      saveAll: "保存全部（冲突编辑器）",
      closeOverlay: "关闭浮层",
      prNextHunk: "下一个代码块（PR 审查）",
      prPrevHunk: "上一个代码块（PR 审查）",
      prNextFile: "下一个文件（PR 审查）",
      prPrevFile: "上一个文件（PR 审查）",
      prToggleViewed: "标记文件为已查看",
      prHideViewed: "隐藏已查看的文件",
      prFilterFiles: "筛选文件",
      prCommentHunk: "评论当前代码块",
      prNextFinding: "下一个 AI 发现项",
      prPrevFinding: "上一个 AI 发现项",
      prSubmitReview: "提交审查",
    },
    gitWorkflow: {
      title: "Git 工作流",
  ...
  commitReview: {
    ...
    reReviewArmed: "下次暂存修复后将自动重新审查一次",
    reReviewRunning: "正在重新审查您的修复...",
    iterations: "第 {0} 轮",
    coverage: "已审查暂存行的 {0}%",
    iterationsTooltip: "本轮周期内已执行的审查次数",
    coverageTooltip: "当前暂存差异中已被审查覆盖的新增行占比",
    decisionTitle: "提交前确认",
    decisionMessage: "此仓库已启用提交审查。请选择如何继续。",
    decisionReviewNow: "立即审查",
    decisionVouch: "个人担保",
    decisionSkip: "跳过",
    decisionCancel: "取消",
