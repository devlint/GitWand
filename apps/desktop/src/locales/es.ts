...
const es: Locale = {
  ...
  header: {
    ...
    pullDirtyTitle: "Cambios sin confirmar",
    pullDirtyMessage: "Tus cambios sin confirmar se guardarán en stash para el pull y se restaurarán automáticamente.",
    pullDirtyConfirm: "Stash y pull",
    pullRefusedDirty: "Pull rechazado: hay cambios sin confirmar.",
    pullAutostashParked: "Pull realizado — tus cambios están en stash y volverán cuando termine la operación.",
    pullAutostashConflict: "Pull realizado, pero al restaurar tus cambios hubo conflictos — resúelvelos en la vista Cambios. Tus cambios están a salvo en el stash.",
  ...
  sidebar: {
    ...
    viewLayout: "Disposición de cambios",
    viewAsList: "Vista de lista",
    viewAsTree: "Vista de árbol",
  ...
  dashboard: {
    ...
    prState_open: "Abierta",
    prState_draft: "Borrador",
    prState_merged: "Fusionada",
    prState_closed: "Cerrada",
  ...
  branches: {
    ...
    switchWorktree: "Esta rama ya está extraída en otro worktree. Usa el Hub de Worktree para abrirla.",
    switchStashTitle: "Stash antes de cambiar de rama",
    ...
    updateDirtyHint: "Tus cambios sin confirmar se guardarán en stash y se restaurarán tras la actualización.",
    updateFailed: "No se pudo actualizar la rama. ({0})",
    updatePopConflict: "Rama actualizada, pero la restauración de tus cambios encontró conflictos: resuélvelos en la vista de Cambios. Tu stash se ha conservado.",
    reset: "Restaurar",
  ...
  rebase: {
    ...
    resolveAuto: "Resolución auto",
    resolveAutoBusy: "Resolviendo auto…",
    resolveAutoHint: "Resuelve cada paso y continúa el rebase automáticamente hasta terminar o hasta un conflicto que no pueda resolver.",
  ...
  merge: {
    ...
    bulkAiSummary: "{0} resueltos, {1} con error",
  ...
  pr: {
    ...
    detail: {
      ...
      autoMergeArm: "Fusionar cuando pasen las verificaciones",
      autoMergeDisarm: "Cancelar fusión programada",
      autoMergeArmed: "Se fusionará cuando pasen las verificaciones",
      autoMergeUnavailable: "Fusión programada no disponible",
      statFiles: "Archivos",
      statDiff: "Diff",
      ...
      reviewChangesRequested: "solicitó cambios",
      reviewDismissed: "revisión descartada",
      reviewCommented: "comentó",
      description: "Descripción",
  ...
  settings: {
    ...
    logsLevelWarn: "AVISO",
    logsLevelInfo: "INFO",
    aiEnable: "Activar las funciones de IA",
    aiEnableHint: "Activa todas las funciones basadas en IA: sugerencias de resolución de conflictos, mensajes de commit, pre-revisión de PR y Revisión de commit de tus cambios en stage. Nada se ejecuta hasta que configures un proveedor abajo.",
    ...
    ai: {
      ...
      releaseNotes: {
        title: "Plantillas de notas de versión",
        hint: "Las plantillas le permiten agregar instrucciones/reglas personalizadas sobre el prompt base para generar notas de versión.",
        sharedNote: "Las plantillas se comparten entre proyectos, pero la plantilla asignada se recuerda para cada proyecto.",
        defaultTemplate: "Predeterminada",
        empty: "Aún no hay plantillas personalizadas.",
        add: "Agregar plantilla",
        formName: "Nombre de la plantilla",
        formRules: "Reglas personalizadas",
    ...
    reviewAi: {
      ...
      preReview: "Hallazgos de pre-revisión",
      preReviewHint: "Analizar cada archivo en segundo plano al abrir una PR (opt-in, local primero).",
      threshold: "Umbral de confianza",
      thresholdHint: "Los hallazgos por debajo de este umbral se ocultan.",
      cap: "Máximo de hallazgos por PR",
      capHint: "Top-N hallazgos mostrados, ordenados por confianza.",
    ...
    commitReview: {
      ...
      rcOverrideHint: "El campo commitReview.enabled del .gitwandrc de un repositorio fuerza esta opción (activada o desactivada) para ese repositorio, sin importar este ajuste.",
    },
    ...
    tierStats: {
      ...
      files: "Archivos en conflicto",
      hunks: "Conflictos",
      trivial: "Triviales (determinista)",
      advanced: "Determinista avanzado",
      model: "Enviados a la IA",
      unresolved: "Manuales (complejos)",
      recoverable: "Recuperable antes de la IA",
      since: "Desde el {0}",
      empty: "Aún no se han registrado conflictos.",
    ...
    pullMerge: "Merge",
    pullRebase: "Rebase (por defecto)",
    pullDirtyBehavior: "Pull con cambios sin confirmar",
    pullDirtyAutostash: "Stash y restauración automáticos",
    pullDirtyAsk: "Preguntar",
    pullDirtyRefuse: "Rechazar si hay cambios",
    pullDirtyHint: "Guarda tus cambios en stash para el pull y los restaura justo después.",
    switchBehavior: "Comportamiento al cambiar de rama",
    switchStash: "Stash automático",
    switchAsk: "Preguntar",
    switchRefuse: "Rechazar si hay cambios",
    resetBranchUpdatePrompts: "Recordatorios de «Actualizar la rama»",
    resetBranchUpdatePromptsBtn: "Reactivar",
    resetBranchUpdatePromptsHint: "Vuelve a mostrar el aviso de actualización tras el checkout para todas las ramas silenciadas.",
    fontSize: "Tamaño de fuente",
    tabSize: "Tamaño del tabulador",
    spaces: "espacios",
    terminalFontSize: "Tamaño de fuente del terminal",
    terminalShell: "Shell del terminal",
    terminalShellHint: "ej. /bin/zsh, pwsh — dejar vacío para el shell predeterminado",
    terminalContextMenu: "Menú contextual (clic derecho)",
    terminalContextMenuHint: "Mostrar un menú con copiar, pegar, limpiar y buscar al hacer clic derecho",
    terminalCopyOnSelect: "Copiar al seleccionar",
    ...
    notificationLevelAll: "Toda la actividad",
    notificationLevelReviews: "Revisiones y comentarios",
    notificationLevelCi: "Solo fallos de CI",
    notificationLevelNone: "Ninguna",
    notificationLevelHint: "Notificaciones nativas del SO para eventos de PR, solo cuando GitWand está en segundo plano.",
    notificationsByPeople: "Solo personas",
  ...
  hooks: {
    ...
    // v3.7.0 (Task 6) — Hook pre-commit de revisión de commit (recordatorio no bloqueante),
    // comparte el mismo script único que el hook de secretos anterior via gitwandHook.ts.
    reviewTitle: "Hook pre-commit de revisión de commit",
    reviewDescription: "Recuerda desde la terminal que la Revisión de commit de GitWand no se ejecutó para un commit. Nunca bloquea, solo es un aviso. El estado de la revisión vive en la app y no se puede comprobar desde un script de shell.",
    reviewInstalled: "Instalado",
    reviewNotInstalled: "No instalado",
  ...
  launchpad: {
    ...
    inboxFilterEmpty: "Nada coincide con este filtro.",
    inboxSummary: "{0} elementos · {1} por hacer",
    timeMin: "{0} min",
    timeHour: "{0} h",
    timeDay: "{0} d",
    timeWeek: "{0} sem",
  ...
  timeMachine: {
    title: "Time Machine",
    subtitle: "Cada operación en este repositorio, restaurable en un clic",
    empty: "Aún no hay operaciones registradas",
    open: "Time Machine",
    seeAll: "Historial completo del repositorio",
    restore: "Restaurar",
    restoreTitle: "¿Restaurar este punto?",
    restoreConfirm:
      "El árbol de trabajo, el índice y la rama actual vuelven a este punto. Antes se toma una instantánea del estado actual, así que esta operación también se puede deshacer.",
    restoreButton: "Restaurar",
    filterAll: "Todo",
    filterSnapshots: "Instantáneas",
    filterGit: "Git",
    retentionSummary: "{0} puntos · {1} d",
    sourceSnapshot: "Instantánea",
    sourceReflog: "Git",
    detailWorktree: "árbol de trabajo + índice",
    detailConflicts: "conflictos preservados",
    detailRefMove: "movimiento de ref",
    kindManual: "Instantánea manual",
    ...
    settingsEnabledHint:
      "Captura el árbol de trabajo, el índice y el estado de conflictos antes de un reset, checkout, descarte o aplicación masiva de resoluciones.",
    settingsRetentionDays: "Conservar instantáneas (días)",
    settingsMaxCount: "Máximo de instantáneas por repositorio",
    settingsAiLabels: "Etiquetas de instantánea generadas por IA",
  },
  undoStack: {
  ...
  worktree: {
    ...
    formBranchAlreadyUsed: "(ya en uso)",
    formNewBranch: "Nombre de la nueva rama (opcional)",
  ...
  submodule: {
    ...
    adding: "Agregando\u2026",
    statusClean: "limpio",
    statusModified: "Sin confirmar",
    statusUninitialized: "no inicializado",
    updateAvailable: "Nueva actualización",
    updateAvailableTooltip: "{0} commit(s) nuevo(s) en la rama seguida — ejecuta Actualizar para traerlos",
    update: "Actualizar",
    updateOneTooltip: "Traer los últimos commits de la rama seguida de este submódulo",
  ...
  errors: {
    ...
    reviewHookInstall: "Error al instalar el hook de revisión de commit: {0}",
    reviewHookRemove: "Error al quitar el hook de revisión de commit: {0}",
  },
  // ─── Tags panel (v1.9)
  tags: {
    title: "Tags",
  ...
  help: {
    ...
    keyboardShortcuts: {
      ...
      prNextHunk: "Bloque siguiente (revisión de PR)",
      prPrevHunk: "Bloque anterior (revisión de PR)",
      prNextFile: "Archivo siguiente (revisión de PR)",
      prPrevFile: "Archivo anterior (revisión de PR)",
      prToggleViewed: "Marcar archivo como visto",
      prHideViewed: "Ocultar archivos vistos",
      prFilterFiles: "Filtrar archivos",
      prCommentHunk: "Comentar el bloque actual",
      prNextFinding: "Siguiente hallazgo de IA",
      prPrevFinding: "Hallazgo de IA anterior",
      prSubmitReview: "Enviar revisión",
    },
    gitWorkflow: {
  ...
  notify: {
    newPr: "Nueva PR #{0}: {1}",
    closed: "PR #{0} cerrada: {1}",
    ciFlip: "CI {0} — #{1}: {2}",
    reviewRequested: "Revisión solicitada — #{0}: {1}",
    reviewDecided: "{0} — #{1}: {2}",
    newComment: "Nuevo comentario — #{0}: {1}",
  },
  error: {
  ...
  commitReview: {
    ...
    reReviewArmed: "Se volverá a revisar automáticamente en cuanto pongas en stage una corrección",
    reReviewRunning: "Revisando de nuevo tu corrección...",
    iterations: "Iteración {0}",
    coverage: "{0}% de las líneas en stage revisadas",
    iterationsTooltip: "Número de pasadas de revisión realizadas en este ciclo",
    coverageTooltip: "Parte de las líneas añadidas del diff en stage actual ya cubierta por una revisión",
    decisionTitle: "Antes de hacer commit",
    decisionMessage: "La revisión de commit está activada para este repositorio. Elige cómo continuar.",
    decisionReviewNow: "Revisar ahora",
    decisionVouch: "Avalar personalmente",
    decisionSkip: "Omitir",
