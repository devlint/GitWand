...
const fr: Locale = {
  ...
  header: {
    ...
    pullDirtyTitle: "Changements non commit\u00e9s",
    pullDirtyMessage: "Tes changements non commit\u00e9s seront stash\u00e9s pour le pull, puis restaur\u00e9s automatiquement.",
    pullDirtyConfirm: "Stasher & pull",
    pullRefusedDirty: "Pull refus\u00e9 : des changements non commit\u00e9s sont pr\u00e9sents.",
    pullAutostashParked: "Pull effectu\u00e9 \u2014 tes changements sont stash\u00e9s et reviendront \u00e0 la fin de l'op\u00e9ration.",
    pullAutostashConflict: "Pull effectu\u00e9, mais la restauration de tes changements a produit des conflits \u2014 r\u00e9sous-les dans la vue Changements. Tes changements sont en s\u00e9curit\u00e9 dans le stash.",
  ...
  dashboard: {
    ...
    prState_open: "Ouverte",
    prState_draft: "Brouillon",
    prState_merged: "Fusionnée",
    prState_closed: "Fermée",
    // README
    formatted: "Formaté",
    raw: "Brut",
  ...
  log: {
    ...
    graphSearchPlaceholder: "Rechercher par id de commit, #pr, auteur, branche, résumé ou description…",
  ...
  branches: {
    ...
    updateDirtyHint: "Vos modifications non commitées seront stashées puis restaurées après la mise à jour.",
    updateFailed: "Impossible de mettre à jour la branche. ({0})",
    updatePopConflict: "Branche mise à jour, mais la restauration de vos modifications a rencontré des conflits — résolvez-les dans la vue Changes. Votre stash a été conservé.",
    reset: "Réinitialiser",
  ...
  merge: {
    ...
    treeTitle: "Conflit d'arborescence",
    treeBadge: "supprimé",
    treeKeepOurs: "Garder la version courante",
    treeKeepTheirs: "Garder la version entrante",
    treeAcceptDelete: "Accepter la suppression",
    treeModifiedOursDeletedTheirs: "Modifié côté courant, supprimé côté entrant",
    treeDeletedOursModifiedTheirs: "Supprimé côté courant, modifié côté entrant",
  ...
  pr: {
    ...
    detail: {
      ...
      reviewChangesRequested: "a demandé des modifications",
      reviewDismissed: "review rejetée",
      reviewCommented: "a commenté",
      description: "Description",
  ...
  settings: {
    ...
    logsLevelWarn: "AVERT",
    logsLevelInfo: "INFO",
    aiEnable: "Activer les fonctionnalit\u00e9s IA",
    aiEnableHint: "Active toutes les fonctionnalit\u00e9s bas\u00e9es sur l'IA : suggestions de r\u00e9solution de conflits, messages de commit, pr\u00e9-revue de PR, et Revue de commit de vos changements index\u00e9s. Rien ne s'ex\u00e9cute tant qu'un fournisseur n'est pas configur\u00e9 ci-dessous.",
    ...
    ai: {
      ...
      releaseNotes: {
        title: "Modèles de notes de version",
        hint: "Les modèles permettent d'ajouter des instructions/règles personnalisées au prompt de base pour la génération des notes de version.",
        sharedNote: "Les modèles sont partagés entre les projets, mais le modèle assigné est mémorisé par projet.",
        defaultTemplate: "Par défaut",
        empty: "Aucun modèle personnalisé.",
        add: "Ajouter un modèle",
        formName: "Nom du modèle",
        formRules: "Règles personnalisées",
        formRulesPlaceholder: "Ex. : Se concentrer sur les correctifs de sécurité, regrouper par backend/frontend, utiliser le français...",
      },
    },
    aiHistory: {
    ...
    reviewAi: {
      title: "Review AI",
      hint: "Passe IA locale et opt-in sur les diffs de PR — constats de pré-review + résumé.",
      preReview: "Constats de pré-review",
      preReviewHint: "Analyser chaque fichier en arrière-plan à l'ouverture d'une PR (opt-in, local d'abord).",
      threshold: "Seuil de confiance",
      thresholdHint: "Les constats sous ce seuil de confiance sont masqués.",
      cap: "Constats max par PR",
      capHint: "Top-N constats affichés, triés par confiance.",
    ...
    tierStats: {
      ...
      files: "Fichiers en conflit",
      hunks: "Conflits",
      trivial: "Triviaux (déterministe)",
      advanced: "Déterministe avancé",
      model: "Envoyés à l'IA",
      unresolved: "Manuels (complexes)",
      recoverable: "Récupérable avant l'IA",
      since: "Depuis le {0}",
      empty: "Aucun conflit enregistré pour l'instant.",
    ...
    pullMerge: "Merge",
    pullRebase: "Rebase (d\u00e9faut)",
    pullDirtyBehavior: "Pull avec des changements non commités",
    pullDirtyAutostash: "Stash & restauration automatiques",
    pullDirtyAsk: "Demander",
    pullDirtyRefuse: "Refuser si modifié",
    pullDirtyHint: "Stashe tes changements pour le pull, puis les restaure juste après.",
    switchBehavior: "Comportement au switch",
    switchStash: "Stash automatique",
    switchAsk: "Demander",
    switchRefuse: "Refuser si modifi\u00e9",
    resetBranchUpdatePrompts: "Rappels \u00ab Mettre \u00e0 jour la branche \u00bb",
    resetBranchUpdatePromptsBtn: "R\u00e9activer",
    resetBranchUpdatePromptsHint: "R\u00e9affiche le prompt de mise \u00e0 jour post-checkout pour toutes les branches mises en sourdine.",
    fontSize: "Taille de police",
    tabSize: "Indentation (tab)",
    spaces: "espaces",
    terminalFontSize: "Taille de police du terminal",
    terminalShell: "Shell du terminal",
    terminalShellHint: "ex. /bin/zsh, pwsh — laisser vide pour le shell par défaut",
    terminalContextMenu: "Menu contextuel (clic droit)",
    terminalContextMenuHint: "Afficher un menu avec copier, coller, effacer et rechercher au clic droit",
    terminalCopyOnSelect: "Copier à la sélection",
  ...
  hooks: {
    ...
    secretsInstallConfirmMessage: "Ceci écrit .git/hooks/pre-commit et exécute « npx @gitwand/cli scan » à chaque commit fait depuis le terminal. Toujours contournable avec « git commit --no-verify ». Si un hook pre-commit existe déjà et est géré par GitWand, ceci ajoute la section secrets sans toucher à la section de revue de commit.",
    secretsInstallConfirmMessageForeign: "Ceci ÉCRASE le hook pre-commit déjà installé à .git/hooks/pre-commit, qui n'est pas géré par GitWand. Le nouveau hook écrit .git/hooks/pre-commit et exécute « npx @gitwand/cli scan » à chaque commit fait depuis le terminal. Toujours contournable avec « git commit --no-verify ».",
    ...
    reviewInstallConfirmMessage: "Ceci écrit .git/hooks/pre-commit (ou l'ajoute au script GitWand existant) pour afficher un rappel à chaque commit terminal indiquant que la Revue de commit ne s'est pas exécutée. Le commit n'est jamais bloqué.",
  ...
  launchpad: {
    ...
    inboxFilterEmpty: "Aucun élément ne correspond à ce filtre.",
    inboxSummary: "{0} éléments · {1} à traiter",
    timeMin: "{0} min",
    timeHour: "{0} h",
    timeDay: "{0} j",
    timeWeek: "{0} sem",
  ...
  forgeConnect: {
    banner: "Connectez votre compte {0} pour voir ses pull requests et issues",
    github: "GitHub",
    gitlab: "GitLab",
    bitbucket: "Bitbucket",
    azure: "Azure DevOps",
  ...
  submodule: {
    ...
    adding: "Ajout\u2026",
    statusClean: "propre",
    statusModified: "Non valid\u00e9",
    statusUninitialized: "non initialis\u00e9",
    updateAvailable: "Nouveaut\u00e9",
    updateAvailableTooltip: "{0} nouveau(x) commit(s) sur la branche suivie \u2014 lancez Mettre \u00e0 jour pour les r\u00e9cup\u00e9rer",
    update: "Mettre \u00e0 jour",
    updateOneTooltip: "R\u00e9cup\u00e9rer les derniers commits de la branche suivie de ce sous-module",
  ...
  help: {
    ...
    keyboardShortcuts: {
      ...
      prNextHunk: "Bloc suivant (revue de PR)",
      prPrevHunk: "Bloc précédent (revue de PR)",
      prNextFile: "Fichier suivant (revue de PR)",
      prPrevFile: "Fichier précédent (revue de PR)",
      prToggleViewed: "Marquer le fichier comme vu",
      prHideViewed: "Masquer les fichiers vus",
      prFilterFiles: "Filtrer les fichiers",
      prCommentHunk: "Commenter le bloc courant",
      prNextFinding: "Constat IA suivant",
      prPrevFinding: "Constat IA précédent",
      prSubmitReview: "Envoyer la revue",
    },
    gitWorkflow: {
      title: "Workflow Git",
  ...
  terminal: {
    ...
    ctxSearch: "Rechercher",
    agentOpenFailed: "Impossible d'ouvrir {0}. Vérifiez que la CLI {0} est installée et présente dans le PATH.",
    menuShell: "Shell",
  ...
  commitReview: {
    ...
    fixWithAgent: "Corriger avec un agent",
    fixWithAgentTooltip: "Saisit ces constats dans le terminal d'un agent (vous appuyez sur Entrée pour l'exécuter)",
    toolClaude: "Claude Code",
    toolCodex: "Codex",
    toolOpencode: "OpenCode",
    reReviewArmed: "Une nouvelle revue automatique se lancera dès que vous indexerez une correction",
    reReviewRunning: "Nouvelle revue de votre correction en cours...",
    iterations: "Passage {0}",
    coverage: "{0}% des lignes indexées passées en revue",
    iterationsTooltip: "Nombre de passes de revue effectuées dans ce cycle",
    coverageTooltip: "Part des lignes ajoutées du diff indexé actuel déjà couverte par une revue",
    decisionTitle: "Avant de valider ce commit",
    decisionMessage: "La revue de commit est activée pour ce dépôt. Choisissez comment procéder.",
    decisionReviewNow: "Passer en revue maintenant",
    decisionVouch: "Valider personnellement",
    decisionSkip: "Ignorer",
    decisionCancel: "Annuler",
