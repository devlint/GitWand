...
const i18n: Record<Locale, any> = {
  fr: {
    ...
    heroAnnounce: "Nouveau dans la v3.10 — Live Repo : le dépôt se rafraîchit tout seul, fini le sondage toutes les 2 secondes",
  ...
  en: {
    ...
    heroAnnounce: "New in v3.10 — Live Repo: the repository refreshes itself, no more polling every 2 seconds",
  ...
  es: {
    ...
    heroAnnounce: "Nuevo en la v3.10 — Live Repo: el repositorio se actualiza solo, se acabó el sondeo cada 2 segundos",
  ...
  'pt-BR': {
    ...
    heroAnnounce: "Novidade na v3.10 — Live Repo: o repositório se atualiza sozinho, sem mais sondagem a cada 2 segundos",
  ...
  'zh-CN': {
    ...
    agentsCta: "探索 AI 与代理 →",
    heroAnnounce: "v3.10 新功能 — Live Repo：仓库自动刷新，告别每 2 秒一次的轮询",
